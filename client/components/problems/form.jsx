        ...
        return (
            <div className='row'>
                ...
                <div className='col-xs-12 col-sm-6'>
                    <div className="form-group">
                        <AutoFillSelectBox
                            searchTitle={this.props.intl.messages['form.topic']}
                ...
                <div className='col-xs-12 col-sm-6'>
                    <div className="form-group">
                        <AutoFillSelectBox
                            searchTitle={this.props.intl.messages['form.difficulty']}
                ...
                <div className='col-xs-12'>
                    <div className="form-group">
                        {this.props.id
                            ...
                            : ''}
                        <label htmlFor="input-problem" className="control-label">
                            <FormattedMessage id="form.problem" /> *
                        </label>
                        <MathTextField name='problem'
...
export default connect(mapStateToProps, mapDispatchToProps)(injectIntl(ProblemForm));

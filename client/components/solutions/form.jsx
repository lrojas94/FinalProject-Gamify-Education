        ...
        return (
            <div className='row'>
                <div className='col-xs-10'>
                    <div className="form-group">
                        {this.props.id
                            ...
                            : ''}
                        <label htmlFor="input-solution{this.props.customId||''}"
                            className="control-label">
                            <FormattedMessage id="form.solution" /> *
                        </label>
                        <MathTextField name='solution'
                ...
                <div className='col-xs-2'>
                    <div className="form-group">
                        <label htmlFor="input-is-correct{this.props.customId}"
                            className="control-label">
                            <FormattedMessage id="form.correct" /> *
                        </label>
                        <input type="checkbox" className="form-control"
                            id="input-is-correct{this.props.customId}"
 ...
 */
export default injectIntl(SolutionForm);

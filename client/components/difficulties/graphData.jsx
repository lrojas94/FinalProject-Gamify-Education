...
class TopicGraphData extends Component {
    constructor(props) {
        ...
        this.generateTopicDistributionChart();
    };
        ...
        return (
            <div className='row'>
                <div className='col-xs-12 col-md-6'>
                    <h4 className='text-center'> <FormattedMessage id='difficulties.chart.rightwrong'/> </h4>
                    <Doughnut data={this.correctAnswersChart}/>
                </div>
                <div className='col-xs-12 col-md-6'>
                    <h4 className='text-center'> <FormattedMessage id='difficulties.chart.topicdistribution'/> </h4>

        ...
        return (
            <div className='row'>
                <div className='col-xs-12'>
                    ...
                    <div className='form-group'>
                        <label htmlFor="input-topic-example" className="control-label">
                            <FormattedMessage id="form.exampleProblem" /> *
                        </label>
                        <MathTextField
                            name='example'
...
export default connect(mapStateToProps, mapDispatchToProps)(injectIntl(TopicForm));

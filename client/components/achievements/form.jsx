        ...
        <div className='row'>
          ...
          <div className='col-xs-12'>
            ...
            <div className="form-group">
              ...
              <input type="text" className="form-control" id="input-topic-iconUrl" onChange={this.props.handleFormChange}
              value={this.props.iconUrl} name='iconUrl' required/>
            </div>
            <div className='form-group'>
          ...
          <div className='col-xs-6'>
            <div className='form-group'>
              <label htmlFor="input-topic-thresholdQuantity" className="control-label">Number of Problems to Solve before unlocking this achievement</label>
              <input type="text" className="form-control" id="input-topic-thresholdQuantity" onChange={this.props.handleFormChange}
              value={this.props.thresholdQuantity} name='thresholdQuantity'/>
            </div>
          </div>
          <div className='col-xs-6'>
            <div className='form-group'>
              <label htmlFor="input-topic-thresholdPercent" className="control-label">Percent of Correct Answered Problems before unlocking this achievement</label>
              <input type="text" className="form-control" id="input-topic-thresholdPercent" onChange={this.props.handleFormChange}
              value={this.props.thresholdPercent} name='thresholdPercent'/>
            </div>
          </div>
          <div className='col-xs-12 col-sm-6'>
            <div className="form-group">
              <AutoFillSelectBox
                searchTitle={'Difficulty this topic belongs to *'}
          ...
          <div className='col-xs-12 col-sm-6'>
            <div className="form-group">
              <AutoFillSelectBox
                searchTitle={'Topic this achievement belongs to*'}

        ...
        <div className='row'>
          <div className='col-xs-12'>
            <div className="form-group">
              ...
              <label htmlFor="input-person-name" className="control-label">Name *</label>
              <input type="text" className="form-control" id="input-person-username" onChange={this.props.handleFormChange}
            ...
            <div className='form-group'>
              ...
              <input type="text" className="form-control" id="input-person-bday" onChange={this.props.handleFormChange}
              value={this.props.birthDay} name='birthDay' required/>
            </div>

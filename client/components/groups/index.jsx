        ...
        elements: [
            {
                ...
                element: 'groups.view.group.data'
            },
...
class GroupMain extends Component {
    ...
    render() {
        return (
            <div>
                <SectionTitle title={this.props.intl.messages['sidebar.groups']}
...
const module = {
    Main: connect(mapStateToProps, mapDispatchToProps)(injectIntl(GroupMain)),
